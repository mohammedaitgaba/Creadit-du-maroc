      ...
      <div className="w-3/4 lg:w-3/6 m-auto text-[#232122] ">
        <form className="bg-[white] p-5 relative">
          ...
          <div className="relative z-0 sm:mb-4 mb-0 w-full group">
            ...
            <button type="button" disabled={isLoading} onClick={()=>Sign_in()} class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Login</button>
      ...
      <div className="w-3/4  m-auto text-senary">
        <form className="bg-[white] p-5 relative">
            <div className="absolute right-6">
                <i className="pi pi-times text-primary cursor-pointer" onClick={()=>Close()}></i>
            </div>
